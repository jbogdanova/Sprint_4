...
public class FAQTest {
    ...
    private final String accordionItemHeading;
    private final String accordionItemPanel;

    public FAQTest(int id, String accordionItemHeading, String accordionItemPanel) {
        this.id = id;
        this.accordionItemHeading = accordionItemHeading;
        this.accordionItemPanel = accordionItemPanel;
    }
